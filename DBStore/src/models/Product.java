...
public class Product {
    ...
    public String getPriceInDollars() {
        ...
        String priceInDollars = (formatter.format(getPrice()));
    ...
    public String toString(){
        return "ID: " + getId() + ", Name: " + getName() + ", Description: " + getDescription() + ", Price: " + getPriceInDollars() + ", Category: " + getCategory().toString() + ", Sale: " + isSale();
    }
}
